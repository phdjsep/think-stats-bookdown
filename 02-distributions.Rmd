...
## Plotting Histograms
    ...
    <tbody>
    <tr class="odd">
    <td style="text-align: left;">Figure 2.1: Histogram of the pound part of birth weight.</span></td>
    </tr>
    </tbody>
    </table>

    </span><span
    id="first_wgt_lb_hist"></span> </span>
...
Section [0.2](thinkstats2001.html#code) for information about installing `matplotlib`. 
...
You can read the documentation for `thinkplot` at [http://greenteapress.com/thinkstats2/thinkplot.html](http://greenteapress.com/thinkstats2/thinkplot.html)
    ...
    <tbody>
    <tr class="odd">
    <td style="text-align: left;">Figure 2.2: Histogram of the ounce part of birth weight.</span></td>
    </tr>
    </tbody>
    </table>
    
    </span><span
    id="first_wgt_oz_hist"></span> </span>
...
downloading and working with this code, see Section [0.2](thinkstats2001.html#code).
...
In Section [1.6](thinkstats2002.html#cleaning) we transformed `agepreg` from centiyears to years,
...
features of histograms.
    ...
    ![](thinkstats2003.png)</span>
     </span>
    <table>
    <tbody>
    <tr class="odd">
    <td style="text-align: left;">Figure 2.3: Histogram of mother’s age at end of pregnancy.</span></td>
    </tr>
    </tbody>
    </table>
     </span><span
    id="first_agepreg_hist"></span> </span>
...
string that appears in the legend when the Hist is plotted. 
    ...
    ![](thinkstats2004.png)</span>
     </span>
    <table>
    <tbody>
    <tr class="odd">
    <td style="text-align: left;">Figure 2.4: Histogram of pregnancy length in weeks.</span></td>
    </tr>
    </tbody>
    </table>
     </span><span
    id="first_prglngth_hist"></span>
    </span>
    

Figure [2.1](#first_wgt_lb_hist) shows the result. The most common value,
...
Figure [2.2](#first_wgt_oz_hist) shows the histogram of `birthwgt_oz`, which is
...
Figure [2.3](#first_agepreg_hist) shows the histogram of `agepreg`, the mother’s
...
Figure [2.4](#first_prglngth_hist) shows the histogram of `prglngth`, the length
...
choose an appropriate collection of colors. 
    ...
    ![](thinkstats2005.png)</span>
     </span>
    <table>
    <tbody>
    <tr class="odd">
    <td style="text-align: left;">Figure 2.5: Histogram of pregnancy lengths.</span></td>
    </tr>
    </tbody>
    </table>
     </span><span
    id="first_nsfg_hist"></span> </span>
...
If you have a sample of `n` values, *x<sub>i</sub>*, the mean, <span
...
<tbody>
<tr class="odd">
<td><span style="text-decoration:overline">x</span> = </span></td>
<td><table>
<tbody>
<tr class="odd">
<td style="text-align: center;">1</span></td>
</tr>
<tr class="even">
...
<td> <span style="font-style:italic">x</span></span><sub><span style="font-style:italic;font-size:medium">i</span></sub> </span></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="odd">
<td><span style="font-style:italic;font-size:medium">S</span><sup>2</span></sup> = </span></td>
<td><table>
<tbody>
<tr class="odd">
<td style="text-align: center;">1</span></td>
...
<td> (<span style="font-style:italic">x</span></span><sub><span style="font-style:italic;font-size:medium">i</span></sub> − <span style="text-decoration:overline">x</span>)</span><sup>2</span></sup> </span></td>
</tr>
</tbody>
</table>

The term *x<sub>i</sub>* − <span
...
<tbody>
<tr class="odd">
<td><span style="font-style:italic">d</span> = </span></td>
<td><table>
<tbody>
<tr class="odd">
<td style="text-align: center;"><span style="text-decoration:overline">x_1</span> − <span style="text-decoration:overline">x_2</span></span></td>
</tr>
<tr class="even">
<td style="text-align: center;"></td>
</tr>
